...
| :--- | :--- | :--- | :--- |
| `cli-foundation` | CLI Loop Foundation | ✅ Done | Modular registry-based CLI loop. |
...
- [Model Router](./tracks/model-router/index.md)
- [Memory Tools](./tracks/memory-tools/index.md)
- [Infrastructure](./tracks/infrastructure/index.md)
